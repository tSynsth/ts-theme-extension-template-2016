...
class Tste {
    ...
    public function admin_pages($pages) {
        $pages[] = array(
            'page_title' => __('TS Theme Extension', $this->_token)
            , 'menu_title' => __('TS Theme Extension', $this->_token)
            /**
            ...
            , 'menu_icon' => esc_url($this->assets_url) . 'img/logo_tste-16.png'
            , 'page_icon' => esc_url($this->assets_url) . 'img/logo_tste-32.png'

            , 'capability' => 'manage_options'
            , 'menu_slug' => 'tste_settings'
